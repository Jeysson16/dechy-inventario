...
const Dashboard = () => {
  ...
  const metrics = useMemo(() => {
    ...
    const paidSales = filteredSales.filter(s => s.status === 'completed' || s.status === 'pending_delivery');
    const totalSalesValue = paidSales.reduce((acc, curr) => acc + (Number(curr.totalValue) || 0), 0);
    ...
    const totalRevenue = paidSales.reduce((acc, curr) => acc + (Number(curr.totalValue) || 0), 0);
